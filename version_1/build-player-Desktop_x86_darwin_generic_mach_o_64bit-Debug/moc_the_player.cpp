...
QT_MOC_LITERAL(1, 10, 10), // "backToMenu"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "setMediaList"
QT_MOC_LITERAL(4, 35, 19), // "QVector<VideoInfo>*"
QT_MOC_LITERAL(5, 55, 4), // "list"
QT_MOC_LITERAL(6, 60, 14) // "backToMenuSlot"

    },
    "ThePlayer\0backToMenu\0\0setMediaList\0"
    "QVector<VideoInfo>*\0list\0backToMenuSlot"
};
...
void ThePlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setMediaList((*reinterpret_cast< QVector<VideoInfo>*(*)>(_a[1]))); break;
        case 2: _t->backToMenuSlot(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ThePlayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThePlayer::backToMenu)) {
                *result = 0;
                return;
            }
        }
