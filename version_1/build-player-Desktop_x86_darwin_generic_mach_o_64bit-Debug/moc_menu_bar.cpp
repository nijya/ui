...
QT_MOC_LITERAL(1, 8, 6), // "toPlay"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 19) // "toPlayButtonClicked"

    },
    "MenuBar\0toPlay\0\0toPlayButtonClicked"
};
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toPlay(); break;
        case 1: _t->toPlayButtonClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuBar::toPlay)) {
                *result = 0;
                return;
            }
        }
